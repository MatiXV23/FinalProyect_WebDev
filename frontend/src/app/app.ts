...
export class App implements OnInit {
  ...
  constructor(private menuCtrl: MenuController) {
    addIcons({
      ...
      map, personAdd, key, lockClosedOutline, mailOutline, shirt, cameraOutline,
