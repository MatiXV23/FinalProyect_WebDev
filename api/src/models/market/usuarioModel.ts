...
export const usuarioModel = Type.Object(
  {
    ...
    articulos_carrito: Type.Optional(
      Type.Array(
        Type.Integer({
          description: "ids de los articulos en el carrito del usuario",
        })
      )
    ),
  },
...
export const UsuarioQueryModel = Type.Optional(
  Type.Object({
...
export const usuarioPostModel = Type.Object(
  {
    ...
    nombres: Type.String({ maxLength: 50 }),
    apellidos: Type.String({ maxLength: 50 }),
    direccion: Type.Optional(Type.String({ maxLength: 50 })),
    is_admin: Type.Boolean(),
    id_departamento: Type.Integer(),
    nro_documento: Type.Optional(Type.String({ maxLength: 8 })),
    foto_url: Type.Optional(Type.String({ maxLength: 520 })),
    ...
    examples: [
      {
        ...
        nro_documento: "12345678",
        foto_url:
          "https://external-preview.redd.it/T1CjKMNYd4oViR3U1SHq7FRwM710QEnTyrboQRxuU0U.jpg?auto=webp&s=ae2c366ede78c8d798b0b78cb25cb9c5e951e088",
        password: "pass",
      },
    ],
  }
